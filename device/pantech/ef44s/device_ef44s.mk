...
PRODUCT_COPY_FILES += \
    device/pantech/ef44s/sensor/sensors.qcom:/system/bin/sensors.qcom \
    device/pantech/ef44s/sensor/libsensor1.so:/system/lib/libsensor1.so \
    device/pantech/ef44s/sensor/libsensor_reg.so:/system/lib/libsensor_reg.so \
    device/pantech/ef44s/sensor/libyas530.so:/system/lib/libyas530.so
...
# Audio firmware
PRODUCT_COPY_FILES += \
    device/pantech/ef44s/firmware/wcd9310_anc.bin:/system/etc/firmware/wcd9310/wcd9310_anc.bin \
    device/pantech/ef44s/firmware/wcd9310_mbhc.bin:/system/etc/firmware/wcd9310/wcd9310_mbhc.bin \
...
PRODUCT_COPY_FILES += \
    ...
    device/pantech/ef44s/keylayout/qt602240_ts_input_ef44s.kl:system/usr/keylayout/qt602240_ts_input_ef44s.kl \
    device/pantech/ef44s/keylayout/Button_Jack.kl:system/usr/keylayout/Button_Jack.kl

# Input device config
PRODUCT_COPY_FILES += \
    device/pantech/ef44s/idc/qt602240_ts_input_ef44s.idc:system/usr/idc/qt602240_ts_input_ef44s.idc
...
PRODUCT_COPY_FILES += \
    device/pantech/ef44s/prebuilt/libOmxVdec.so:/system/lib/libOmxVdec.so
...
# Telephony fixes
# Error patch, but ril is applyed (StartME.sh)
