...
COMMON_GLOBAL_CFLAGS += -DEF44S -DNEED_UMS_ENABLE
...
#-include vendor/pantech/ef44s/BoardConfigVendor.mk
...
# custom Bluetooth.c
TARGET_CUSTOM_BLUEDROID := ../../../device/pantech/ef44s/bluetooth/bluetooth.c
# bluetooth.txt by Mir
BOARD_BLUEDROID_VENDOR_CONF := device/pantect/ef44s/bluetooth/vnd_ef44s.txt
...
TARGET_PREBUILT_KERNEL := device/pantech/ef44s/kernel
...
#BOARD_VENDOR_QCOM_GPS_LOC_API_HARDWARE := ef44s
...
# Recovery
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/pantech/ef44s/recovery/recovery_keys.c
TARGET_RECOVERY_PIXEL_FORMAT := RGBX_8888
BOARD_HAS_NO_SELECT_BUTTON := true
TARGET_USERIMAGES_USE_EXT4 := true
BOARD_SUPPRESS_EMMC_WIPE := true

# commit for cm10.1 by Mir
TARGET_ARCH := arm
